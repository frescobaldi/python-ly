...
papervariables = (
    ...
    'top-system-spacing',
    # the distance from the top of the printable area (i.e. the bottom of the
    # top margin) to the first (title or top-level) markup on a page, when
    # there is no system between the two.
    'top-markup-spacing',
    ...
    # not used by ly:optimal-breaking since it will never consider blank pages
    # in the middle of a score.
    'blank-page-force',
    # The page-breaking algorithm to use. Choices are ly:minimal-breaking,
    # ly:page-turn-breaking, and ly:optimal-breaking.
    'page-breaking',
    # Tricks the page breaker into thinking that system-system-spacing is set
    # to something different than it really is. For example, if
